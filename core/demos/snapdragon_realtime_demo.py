#!/usr/bin/env python3
"""
Snapdragon X Elite Real-time Fall Detection Demo
...
class RealtimeFallDetector:
    ...
    def __init__(self, camera_index=0, enable_acceleration=True, resolution=None):
    ...
    def open_camera(self):
        ...
        try:
            ...
            logger.info("AWS Virtual Camera RFC not found, falling back to standard OpenCV")
