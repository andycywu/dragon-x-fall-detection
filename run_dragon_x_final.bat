...
REM Run dragon_x_final.py with Python 3.10
echo Running Dragon X Fall Detection Final Solution with Python 3.10...
"C:\Users\HCKTest\AppData\Local\Programs\Python\Python310\python.exe" C:\dragon-x-fall-detection\dragon_x_final.py
