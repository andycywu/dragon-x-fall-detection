@echo off
echo Dragon X Fall Detection System - Real QAI Hub Inference (ASCII)
echo ==========================================================
echo.
...
if not exist "C:\dragon-x-fall-detection\dragon_x_real_inference_ascii.py" (
    echo Error: dragon_x_real_inference_ascii.py not found
    goto :exit
)

REM Use the correct Python path
echo Running Python script with correct Python path...
C:\Users\HCKTest\AppData\Local\Programs\Python\Python310\python.exe C:\dragon-x-fall-detection\dragon_x_real_inference_ascii.py
