...
REM Run dragon_x_fall_detection_english.py with Python 3.10
echo Running English version of Dragon X Fall Detection System with Python 3.10...
"C:\Users\HCKTest\AppData\Local\Programs\Python\Python310\python.exe" C:\dragon-x-fall-detection\dragon_x_fall_detection_english.py
