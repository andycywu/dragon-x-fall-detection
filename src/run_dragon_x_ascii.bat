...
REM Run ASCII version of Dragon X system with Python 3.10
echo Running ASCII version of Dragon X Fall Detection System with Python 3.10...
"C:\Users\HCKTest\AppData\Local\Programs\Python\Python310\python.exe" C:\dragon-x-fall-detection\dragon_x_ascii.py
